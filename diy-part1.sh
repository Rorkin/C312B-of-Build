...
if [ -f "$KCONFIG_FILE" ]; then
    # Add NAND/UBI/UBIFS related configs (skip if already present)
...
# ============================================================
# 10. NAND driver kernel patch
# ============================================================
echo "[10/10] Installing NAND driver kernel patch..."

PATCH_DIR="target/linux/ramips/patches-5.15"
mkdir -p "$PATCH_DIR"
cp "$DEVICE_DIR/0038-mtd-ralink-add-mt7620-nand-driver.patch" \
   "$PATCH_DIR/0038-mtd-ralink-add-mt7620-nand-driver.patch"

echo "    NAND driver patch installed"
