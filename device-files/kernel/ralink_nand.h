...
#define CONFIG_CHIP_SIZE_BIT (nand_size_map[is_nand_page_2048][nand_addrlen-3])
#define CONFIG_PAGE_SIZE_BIT (is_nand_page_2048? 11 : 9)
#define CONFIG_NUMPAGE_PER_BLOCK_BIT (is_nand_page_2048? 6 : 5)
#define CONFIG_OOBSIZE_PER_PAGE_BIT (is_nand_page_2048? 6 : 4)
#define CONFIG_BAD_BLOCK_POS (is_nand_page_2048? 0 : 4)
#define CONFIG_ECC_BYTES 3
#define CONFIG_ECC_OFFSET (is_nand_page_2048? 6 : 5)
